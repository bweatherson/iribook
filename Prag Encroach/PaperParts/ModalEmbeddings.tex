...
\numbex{2}{
\item \label{ex:HadWon} If I had won the last Presidential election, everyone who voted for me would regret it by now.
\item \label{ex:HillaryClinton} If Hilary Clinton had been the Democratic nominee in the last Presidential election, everyone who voted for Barack Obama would have voted for her.
}
...
\numbex{3}{
\item \label{ex:NoPhil} If there were no philosophers, then the philosophers doing research in the field of applied ethics would be missed most painfully by the public.
\item \label{ex:NoBeer} If there were no beer, everybody drinking beer on a regular basis would be much healthier.
\item \label{ex:NoPeople} If I suddenly were the only person alive, I would miss the Frege scholars most.
}
...
\numbex{1}{
\item \label{ex:Fridge} If I were to look in the fridge and ignore Cartesian doubts, then I'd know there is beer in the fridge.
}
