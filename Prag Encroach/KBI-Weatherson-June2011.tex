...
\footnotetext[0]{\hspace{-6pt} \(^\dagger\) Penultimate draft only. Please cite published version if possible. Final version forthcoming in a volume on knowledge ascriptions edited by Jessica Brown and Mikkel Gerken.}
